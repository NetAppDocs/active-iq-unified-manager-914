...
* Red Hat Enterprise Linux versions 7.x and from 8.0 to 8.9, based on x86_64 architecture.
...
* MySQL Community Edition version 8.0.34 (from the MySQL repository).
* OpenJDK version 11.0.21 (from the Red Hat Extra Enterprise Linux Server repository)
* Python 3.6.x
...
* You must install only one version of Java on your Unified Manager host; otherwise, the system may not be able to determine which version to use. See https://kb.netapp.com/data-mgmt/AIQUM/AIQUM_Kbs/After_updating_Java_on_the_Active_IQ_Unified_Manager_host_services_will_not_start[After updating Java on the Active IQ Unified Manager host, services will not start].
