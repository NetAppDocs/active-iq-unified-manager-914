...
You can also restart the virtual machine from vSphere by using the VMware *Restart Guest* option.Refer to the https://developer.broadcom.com/powercli/latest/vmware.vimautomation.core/commands/restart-vmguest/[Restart-VMGuest cmdlet in Broadcom's VMware vSphere PowerCLI CMDLET reference.^]
